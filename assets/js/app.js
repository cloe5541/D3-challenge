...
// Add a second label group for axis left of the chart
...
//Create a function to chart and visualize data
function visualize(data){
    ...
    var theCircles = svg.selectAll("g the Circles").data(data).enter()
    ...
    theCircles
        ...
        .on("mouseover", function(d){
            toolTip.show(d)
            d3.select(`.${d.abbr}`).style("stroke","#3232332");
        })
        .on("mouseout", function(d){
            toolTip.hide(d)
